...
{
    public partial class BrandsReport : Form
    {
        SqlConnection con;
        ...
        private void BrandsReport_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void BrandsReport_Load(object sender, EventArgs e)
        {
            ...
            rprt.Load(@"C:\Users\Zaryab\source\repos\ResponsiveDesign\ResponsiveDesign\Reports\BrandsCrystalReport.rpt");
            SqlCommand cmd = new SqlCommand("getBrand", con);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            sda.Fill(ds, "BrandsView");
            rprt.SetDataSource(ds);
            brandcrystalReportViewer1.ReportSource = rprt;
        }
    }
}
