...
namespace ResponsiveDesign.Reports
{
    public partial class StockReport : Form
    {
        ...
        private void StockReport_Load(object sender, EventArgs e)
        {
            ...
            rprt.Load(@"C:\Users\Zaryab\source\repos\ResponsiveDesign\ResponsiveDesign\Reports\StockCrystalReport.rpt");
            SqlCommand cmd = new SqlCommand("getStock", con);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            sda.Fill(ds, "Stock_View");
            rprt.SetDataSource(ds);
            stockcrystalReportViewer1.ReportSource = rprt;
