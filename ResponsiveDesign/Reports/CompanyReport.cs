...
namespace ResponsiveDesign.Reports
{
    public partial class CompanyReport : Form
    {
        ...
        private void CompanyReport_Load(object sender, EventArgs e)
        {
            ...
            rprt.Load(@"C:\Users\Zaryab\source\repos\ResponsiveDesign\ResponsiveDesign\Reports\CompanyCrystalReport.rpt");
            SqlCommand cmd = new SqlCommand("getcompany", con);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            sda.Fill(ds, "Company_Table");
        ...
        private void CompanyReport_FormClosing(object sender, FormClosingEventArgs e)
        {
