...
namespace ResponsiveDesign.Reports
{
    public partial class EmployeeReport : Form
    {
        ...
        private void EmployeeReport_Load(object sender, EventArgs e)
        {
            ...
            rprt.Load(@"C:\Users\Zaryab\source\repos\ResponsiveDesign\ResponsiveDesign\Reports\EmployeeCrystalReport.rpt");
            SqlCommand cmd = new SqlCommand("getempview", con);
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter sda = new SqlDataAdapter(cmd);
            DataSet ds = new DataSet();
            sda.Fill(ds, "EmpAllView");
            rprt.SetDataSource(ds);
            employecrystalReportViewer1.ReportSource = rprt;
        }
        ...
        private void EmployeeReport_FormClosing(object sender, FormClosingEventArgs e)
        {
